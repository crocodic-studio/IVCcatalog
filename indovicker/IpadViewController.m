...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    NSLog(@"panjang x lebar = %f x %f", self.view.frame.size.width, self.view.frame.size.height);
...
//        self.mTableView.frame = f;
        ...
        self.tableViewS.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height);
...
- (void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation
{
    ...
    if (self.view.frame.size.width == 1024.000000) {
       // _btnMenu.frame = CGRectMake(_swipeView.frame.size.width/2.1, _btnMenu.frame.origin.y, _btnMenu.frame.size.width, _btnMenu.frame.size.height);
        /*
        _viewMenuIpad = [[UIView alloc] init];
        _viewMenuIpad.frame = CGRectMake(770, 0, 260, 768);
        [_viewMenuIpad setBackgroundColor:[UIColor whiteColor]];
        
        _btnOfficeRight = [[UIButton alloc] init];
        _btnOfficeRight.frame = CGRectMake(0, 0, 260, 86);
        [_btnOfficeRight setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
        [_btnOfficeRight setTitle:@"OFFICE" forState:UIControlStateNormal];
        [_btnOfficeRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];

        _btnPublicAreaRight = [[UIButton alloc] init];
        _btnPublicAreaRight.frame = CGRectMake(0, 88, 260, 86);
        [_btnPublicAreaRight setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
        [_btnPublicAreaRight setTitle:@"PUBLIC AREA" forState:UIControlStateNormal];
        [_btnPublicAreaRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];

        _btnHospitalRight = [[UIButton alloc] init];
        _btnHospitalRight.frame = CGRectMake(0, 176, 260, 86);
        [_btnHospitalRight setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
        [_btnHospitalRight setTitle:@"HOSPITALITY" forState:UIControlStateNormal];
        [_btnHospitalRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];

        _btnAboutUsRight = [[UIButton alloc] init];
        _btnAboutUsRight.frame = CGRectMake(0, 264, 260, 86);
        [_btnAboutUsRight setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
        [_btnAboutUsRight setTitle:@"ABOUT US" forState:UIControlStateNormal];
        [_btnAboutUsRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];

        _btnAuditoriumSeatingRight = [[UIButton alloc] init];
        _btnAuditoriumSeatingRight.frame = CGRectMake(0, 352, 260, 86);
        [_btnAuditoriumSeatingRight setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
        [_btnAuditoriumSeatingRight setTitle:@"AUDITORIUM SEATING" forState:UIControlStateNormal];
        [_btnAuditoriumSeatingRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];

        _btnMultipurposeSeatingRight = [[UIButton alloc] init];
        _btnMultipurposeSeatingRight.frame = CGRectMake(0, 440, 260, 86);
        [_btnMultipurposeSeatingRight setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
        [_btnMultipurposeSeatingRight setTitle:@"MULTIPURPOSE SEATING" forState:UIControlStateNormal];
        [_btnMultipurposeSeatingRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];

        _btnEducationalInstitutionalRight = [[UIButton alloc] init];
        _btnEducationalInstitutionalRight.frame = CGRectMake(0, 528, 260, 86);
        [_btnEducationalInstitutionalRight setBackgroundColor:[UIColor groupTableViewBackgroundColor]];
        [_btnEducationalInstitutionalRight setTitle:@"EDUCATIONAL INSTITUTIONAL" forState:UIControlStateNormal];
        [_btnEducationalInstitutionalRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];

        [_viewMenuIpad addSubview:_btnOfficeRight];
        [_viewMenuIpad addSubview:_btnPublicAreaRight];
        [_viewMenuIpad addSubview:_btnAboutUsRight];
        [_viewMenuIpad addSubview:_btnHospitalRight];
        [_viewMenuIpad addSubview:_btnMultipurposeSeatingRight];
        [_viewMenuIpad addSubview:_btnAuditoriumSeatingRight];
        [_viewMenuIpad addSubview:_btnEducationalInstitutionalRight];
        
        [_btnAboutUsRight addTarget:self action:@selector(leftButtonDidTouch:) forControlEvents:UIControlEventTouchUpInside];
        _btnAboutUsRight.tag = 1;
        [_btnHospitalRight addTarget:self action:@selector(leftButtonDidTouch:) forControlEvents:UIControlEventTouchUpInside];
        _btnHospitalRight.tag = 2;
        [_btnPublicAreaRight addTarget:self action:@selector(leftButtonDidTouch:) forControlEvents:UIControlEventTouchUpInside];
        _btnPublicAreaRight.tag = 3;
        [_btnOfficeRight addTarget:self action:@selector(leftButtonDidTouch:) forControlEvents:UIControlEventTouchUpInside];
        _btnOfficeRight.tag = 4;
        [_btnAuditoriumSeatingRight addTarget:self action:@selector(leftButtonDidTouch:) forControlEvents:UIControlEventTouchUpInside];
        _btnAuditoriumSeatingRight.tag = 5;
        [_btnMultipurposeSeatingRight addTarget:self action:@selector(leftButtonDidTouch:) forControlEvents:UIControlEventTouchUpInside];
        _btnMultipurposeSeatingRight.tag = 6;
        [_btnEducationalInstitutionalRight addTarget:self action:@selector(leftButtonDidTouch:) forControlEvents:UIControlEventTouchUpInside];
        _btnEducationalInstitutionalRight.tag = 8;

        
        //[self.view addSubview:_viewMenuIpad];
        */
    }
...
/*
- (void)leftButtonDidTouch:(UIButton *)sender{
    if (sender.tag == 1) {
        isOffice = YES;
        isHospital = NO;
        isPublicArea = NO;
...
- (UIView *)swipeView:(SwipeView *)swipeView viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view
{
    ...
    if (view == nil)
    {
        ...
        view.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
...
- (UITableViewCell *)tableView:(UITableView *)atableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (isAboutUs) {
        ...
        if (isPortrait) {
            static NSString *filteredCell = @"AboutUsIpadCell";
            
            AboutUsIpadCell *cell = (AboutUsIpadCell *)[atableView dequeueReusableCellWithIdentifier:filteredCell];
            if (cell == nil) {
                [[NSBundle mainBundle] loadNibNamed:@"AboutUsIpadCell" owner:self options:nil];
            ...
            static NSString *filteredCell = @"AboutUsIpadLandscapeCell";
            
            AboutUsIpadLandscapeCell *cell = (AboutUsIpadLandscapeCell *)[atableView dequeueReusableCellWithIdentifier:filteredCell];
            if (cell == nil) {
                [[NSBundle mainBundle] loadNibNamed:@"AboutUsIpadLandscapeCell" owner:self options:nil];
        ...
        static NSString *filteredCell = @"HospitalIpadCell";
        
        HospitalIpadCell *cell = (HospitalIpadCell *)[atableView dequeueReusableCellWithIdentifier:filteredCell];
        if (cell == nil) {
            [[NSBundle mainBundle] loadNibNamed:@"HospitalIpadCell" owner:self options:nil];
